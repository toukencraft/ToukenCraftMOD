...
public class ToukenGuiMenu extends AbstractContainerMenu {
    private static final ResourceLocation TOUSOU_SLOT_SPRITE = new ResourceLocation(ToukenCraft.MOD_ID, "item/empty_armor_slot_tousou");
        ...
        // 装備スロット (インデックス : 52)
        {
            var container = new ContainerSingleItem() {
                ...
                public void setItem(int slot, ItemStack stack) {
                    toukenEntity.setItemSlot(EquipmentSlot.CHEST, stack);
                }
            ...
            this.addSlot(new Slot(container, 0, xOffset1, yOffset1 + slotSize) {
                ...
                public @NotNull Pair<ResourceLocation, ResourceLocation> getNoItemIcon() {
                    return Pair.of(InventoryMenu.BLOCK_ATLAS, TOUSOU_SLOT_SPRITE);
                }
            });
        }
    }
